...
from settings import TYPE_CHECKING, Vector2, pygame
from sprites import StateAnimatedSprite
from tymer import Timer

if TYPE_CHECKING:
    from pygame.mixer import Sound

    from sprites import MovingSprite, Sprite
