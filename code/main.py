...
from settings import FPS, TYPE_CHECKING, WINDOW_H, WINDOW_W, pygame, sys
from support import import_folder, import_folder_dict, import_image, import_sub_folders
...
class Game:
    ...
    def import_assets(self) -> None:
        self.level_frames = {
            ...
            "spike": import_image(
                "..", "graphics", "enemies", "spike_ball", "Spiked Ball"
            ),
            ...
            "cloud_large": import_image(
                "..", "graphics", "level", "clouds", "large_cloud"
            ),
        }
